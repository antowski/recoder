...
Как разработчик
Я хочу иметь возможность изменять кодировку файла на UTF-8
...
Сценарий: Перекодировка одного текстового файла
    ...
    И сохраняю в контекст имя тестового файла "example.1s"
    И сохраняю в контекст имя эталонного файла "example_UTF8.1s"
